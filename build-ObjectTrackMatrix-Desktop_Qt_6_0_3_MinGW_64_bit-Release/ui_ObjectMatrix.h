...
public:
    ...
    void setupUi(QWidget *ObjectMatrix)
    {
        if (ObjectMatrix->objectName().isEmpty())
            ObjectMatrix->setObjectName(QString::fromUtf8("ObjectMatrix"));
        ...
        label_objectMatrix->setObjectName(QString::fromUtf8("label_objectMatrix"));
        ...
        tableWidget_objects->setObjectName(QString::fromUtf8("tableWidget_objects"));
