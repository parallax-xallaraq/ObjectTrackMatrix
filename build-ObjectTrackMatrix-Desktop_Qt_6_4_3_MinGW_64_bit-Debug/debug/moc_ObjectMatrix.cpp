...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ObjectMatrix_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ObjectMatrix_t qt_meta_stringdata_ObjectMatrix = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ObjectMatrix[] = {
...
Q_CONSTINIT const QMetaObject ObjectMatrix::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ObjectMatrix.offsetsAndSizes,
    qt_meta_data_ObjectMatrix,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ObjectMatrix_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ObjectMatrix, std::true_type>
    >,
    nullptr
} };
