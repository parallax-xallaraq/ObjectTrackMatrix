...
public:
    ...
    void setupUi(QWidget *GetUserInfo)
    {
        ...
        dateEdit_experimentDate->setObjectName("dateEdit_experimentDate");

        gridLayout->addWidget(dateEdit_experimentDate, 3, 1, 1, 1);

        label_experimenterName = new QLabel(GetUserInfo);
        label_experimenterName->setObjectName("label_experimenterName");
        ...
        lineEdit_experimenterName->setObjectName("lineEdit_experimenterName");
        ...
        label_errTitle->setObjectName("label_errTitle");
        QFont font;
        font.setBold(true);
        ...
        plainTextEdit_notes->setObjectName("plainTextEdit_notes");
